...
public class ViewKichThuoc extends javax.swing.JFrame {
    ...
    private void showTable(List<KichThuoc> list) {
        dtm.setRowCount(0);
        int index = 0;
    ...
    private KichThuoc showIndex(int index) {
        list = service.findAll();
        KichThuoc detail = list.get(index);
    ...
    public KichThuoc data() {
        ...
        KichThuoc ms = new KichThuoc(Long.MIN_VALUE, ten, trangThai);
        return ms;
    }
    ...
    private void tbMauSacMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbMauSacMouseClicked
        ...
        showIndex(index);
        idKichThuoc = showIndex(index).getId();
        System.out.println("id ms : " + idKichThuoc);
    }//GEN-LAST:event_tbMauSacMouseClicked

    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if (data() != null) {
            KichThuoc detail = data();
            if (detail != null) {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (data() != null) {
            ...
            detail.setId(idKichThuoc);  // Giả sử `idMauSac` lấy từ dòng đã chọn
            if (detail != null) {
