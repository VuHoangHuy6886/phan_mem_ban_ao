...
public class ViewKieuDang extends javax.swing.JFrame {
    ...
    private void showTable(List<KieuDang> list) {
        dtm.setRowCount(0);
        int index = 0;
    ...
    private KieuDang showIndex(int index) {
        list = service.findAll();
        KieuDang detail = list.get(index);
    ...
    public KieuDang data() {
        ...
        KieuDang detail = new KieuDang(Long.MIN_VALUE, ten, trangThai);
        return detail;
    }
    ...
    private void tbMauSacMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbMauSacMouseClicked
        ...
        showIndex(index);
        idKieuDang = showIndex(index).getId();
        System.out.println("id ms : " + idKieuDang);
    }//GEN-LAST:event_tbMauSacMouseClicked

    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if (data() != null) {
            KieuDang detail = data();
            if (detail != null) {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (data() != null) {
            ...
            detail.setId(idKieuDang);  // Giả sử `idMauSac` lấy từ dòng đã chọn
            if (detail != null) {
